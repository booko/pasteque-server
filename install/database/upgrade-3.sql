...
ALTER TABLE PRODUCTS ADD COLUMN DELETED BIT DEFAULT b'0' NOT NULL;
...
ALTER TABLE TICKETS ADD CONSTRAINT TICKETS_TARIFFAREA_FK FOREIGN KEY (TARIFFAREA) REFERENCES TARIFFAREAS(ID);
...
INSERT INTO CURRENCIES(ID, NAME, SYMBOL, DECIMALSEP, THOUSANDSSEP, RATE, FORMAT, MAIN) VALUES (0, 'Euro', '€', ',', ' ', 1.0, '#0.00 $', 1);
ALTER TABLE PAYMENTS ADD COLUMN CURRENCY INTEGER NOT NULL AFTER TOTAL;
ALTER TABLE PAYMENTS ADD COLUMN TOTALCURRENCY DOUBLE NOT NULL AFTER CURRENCY;
...
UPDATE APPLICATIONS SET VERSION = 4 WHERE ID = "postech";

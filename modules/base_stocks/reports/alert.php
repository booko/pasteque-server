...
$sql = "SELECT "
    . "LOCATIONS.NAME AS NAME, PRODUCTS.NAME AS PRODUCTNAME, PRODUCTS.REFERENCE AS REFERENCE, STOCKCURRENT.UNITS, STOCKLEVEL.STOCKSECURITY, STOCKLEVEL.STOCKMAXIMUM "
    . "FROM STOCKCURRENT "
    ...
    . "AND STOCKCURRENT.UNITS > STOCKLEVEL.STOCKMAXIMUM) "
    . "OR STOCKCURRENT.UNITS < 0 "
    . "ORDER BY STOCKLEVEL.LOCATION";

$fields = array("NAME", "PRODUCTNAME", "REFERENCE", "UNITS","STOCKSECURITY","STOCKMAXIMUM");
$headers = array(
    \i18n("Location.label"),
    \i18n("Product.label"),

...
<form method="POST" action="<?php echo \Pasteque\get_current_url(); ?>">
    <input type="hidden" name="submit_request" value="1" />
    <label for="login"><?php \pi18n("BaseAccounts.login"); ?></label> <input type="text" name="login" /><br />
    <label for="first_name"><?php \pi18n("BaseAccounts.first_name"); ?></label> <input type="text" name="first_name" /><br />
    <label for="last_name"><?php \pi18n("BaseAccounts.last_name"); ?></label> <input type="text" name="last_name" /><br />
    <label for="email"><?php \pi18n("BaseAccounts.email"); ?></label> <input type="text" name="email" /><br />
    <label for="website"><?php \pi18n("BaseAccounts.website"); ?></label> <input type="text" name="website" /><br />
    <input type="checkbox" name="accept_contract"><?php \pi18n("BaseAccounts.contract"); ?></input><br />
    <input type="checkbox" name="usage_coffeeshop"><?php \pi18n("BaseAccounts.usage_coffeeshop"); ?></input><br />
    <input type="checkbox" name="subscribe_newsletter"><?php \pi18n("BaseAccounts.subscribe_newsletter"); ?></input><br />
    <label for="password"><?php \pi18n("BaseAccounts.password"); ?></label> <input type="password" name="password" /><br />
    <label for="confirm_password"><?php \pi18n("BaseAccounts.confirm_password"); ?></label> <input type="password" name="confirm_password" /><br />
    <input type="submit" />
</form>

...
$report = \Pasteque\get_report(PLUGIN_NAME, "customers_diary");
?>
<h1><?php \pi18n("Customer's diary", PLUGIN_NAME); ?></h1>

<p><a class="btn" href="<?php echo \Pasteque\get_report_url(PLUGIN_NAME, 'customers_diary'); ?>&start=<?php echo $startStr; ?>&stop=<?php echo $stopStr; ?>&id=<?php echo $_GET['id']; ?>"><?php \pi18n("Export"); ?></a></p>

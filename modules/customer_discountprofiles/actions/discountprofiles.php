...
<ul class="bt_fonction">
	<li><?php \Pasteque\tpl_btn('btn bt_add', \Pasteque\get_module_url_action(PLUGIN_NAME, "discountprofile_edit"),
        \i18n('New discount profile', PLUGIN_NAME), 'img/btn_add.png');?></a></li>
</ul>

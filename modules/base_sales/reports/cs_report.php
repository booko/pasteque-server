...
$sqls[] = "SELECT AVERAGE.HOST, AVERAGE.DATESTART, AVERAGE.DATEEND, "
        ...
        . "GROUP BY TICKET, CLOSEDCASH.MONEY, HOST, DATESTART, DATEEND) "
        . "AS LIST "
        . "GROUP BY LIST.MONEY, LIST.HOST, LIST.DATESTART, LIST.DATEEND "
        . ") AS AVERAGE "
        . ""
        . "LEFT JOIN "
...
$sqls[] = "SELECT CLOSEDCASH.HOST, CLOSEDCASH.DATESTART, "
        ...
        . "GROUP BY CLOSEDCASH.MONEY, CLOSEDCASH.HOST, CLOSEDCASH.DATESTART, "
        . "CLOSEDCASH.DATEEND, __KEY__ "

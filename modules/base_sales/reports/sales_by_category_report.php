...
$sql = "SELECT "
        ...
        . "(SUM(TICKETLINES.UNITS) * (TICKETLINES.PRICE * (SELECT SUM(1 + TAXES.RATE) FROM TAXES WHERE PRODUCTS.TAXCAT = TAXES.CATEGORY AND TAXES.VALIDFROM < RECEIPTS.DATENEW ORDER BY TAXES.VALIDFROM DESC LIMIT 0,1))) AS TAXEDTOTAL "
        . "FROM CLOSEDCASH "

...
$report = \Pasteque\get_report(PLUGIN_NAME, "sales_by_product_report");
?>
<h1><?php \pi18n("Sales by product", PLUGIN_NAME); ?></h1>

<p><a class="btn" href="<?php echo \Pasteque\get_report_url(PLUGIN_NAME, 'sales_by_product_report'); ?>&start=<?php echo $startStr; ?>&stop=<?php echo $stopStr; ?>"><?php \pi18n("Export"); ?></a></p>

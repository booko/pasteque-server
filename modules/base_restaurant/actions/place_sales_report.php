...
$report = \Pasteque\get_report(PLUGIN_NAME, "place_sales_report");
?>
<h1><?php \pi18n("Place sales", PLUGIN_NAME); ?></h1>

<?php
// a remplacer par le template
?>
<p><a class="btn" href="<?php echo \Pasteque\get_report_url(PLUGIN_NAME, 'place_sales_report'); ?>&start=<?php echo $startStr; ?>&stop=<?php echo $stopStr; ?>"><?php \pi18n("Export"); ?></a></p>
